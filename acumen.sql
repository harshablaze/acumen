...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 02, 2020 at 04:32 AM
...
(2, 'DLD', 2017, 2, 1, 'A', 1),
(3, 'DMS', 2017, 2, 1, 'A', 2),
(4, 'OOP W', 2017, 2, 1, 'A', 1),
(5, 'PS&QT', 2017, 2, 1, 'A', 2),
(6, 'DS LA', 2017, 2, 1, 'A', 1),
(7, 'DE LA', 2017, 2, 1, 'A', 1),
(8, 'JAVA', 2017, 2, 1, 'A', 1),
(9, 'DS&A', 2017, 2, 1, 'B', 2),
(10, 'DLD', 2017, 2, 1, 'B', 1),
(11, 'DMS', 2017, 2, 1, 'B', 2),
(12, 'OOP W', 2017, 2, 1, 'B', 2),
(13, 'PS&QT', 2017, 2, 1, 'B', 2),
(14, 'DS LA', 2017, 2, 1, 'B', 2),
(15, 'DE LA', 2017, 2, 1, 'B', 1),
(16, 'JAVA', 2017, 2, 1, 'B', 1);
...
INSERT INTO `users` (`uid`, `username`, `email`, `password`, `access`) VALUES
(1, 'sivaranjani', 'sivaranjani.cse@anits.edu.in', '1234', 1),
(2, 'admin', NULL, 'admin', 2),
(3, 'pranitha', '', '1234', 0);
...
--
ALTER TABLE `facultymap`
  MODIFY `fmpid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
